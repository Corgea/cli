...
The profile fixtures track `packageProfileHandler` (vuln-api repo:
`cve_worker/src/worker.js`, ~lines 484-541); the CLI deserializes a tolerant
subset and ignores the extra fields.
